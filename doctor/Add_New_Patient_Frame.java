 ...
 * @author admin
 */
public class Add_New_Patient_Frame extends javax.swing.JFrame {
    ...
    public Add_New_Patient_Frame() {
        super("Add New Patient Frame");
        initComponents();
        
        String patient_num=new Patient_Number().getGroupNumber(st);
        jTextField1.setText(patient_num);
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(591, 26, 660, 762);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(pname.isEmpty())
         ...
         {
             Add_Patient_Infomation api=new Add_Patient_Infomation();
             if(api.isPatientInfoAdded(st, pid, pname, dob, age, gender, emailid, mobileno, major_illness, doc_name, Doctor_Edit_Profile_Frame.username,date_time))
                  JOptionPane.showMessageDialog(null, "New Patient Information Added Successfully");
             else
                  JOptionPane.showMessageDialog(null, "Error In New Patient Add");
         }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_New_Patient_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_New_Patient_Frame().setVisible(true);
            }
        });
    }
