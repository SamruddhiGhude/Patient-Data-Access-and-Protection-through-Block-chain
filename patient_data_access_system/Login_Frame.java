...
import DB_Operation.Doctor_Login;
import DB_Operation.Patient_Login;
import doctor.Doctor_Edit_Profile_Frame;
import doctor.Doctor_Operation_Frame;
import doctor.Doctor_Registration_Frame;
import java.awt.Dimension;
import java.awt.Toolkit;
import java.sql.Statement;
import javax.swing.JOptionPane;
import patient.Patient_Edit_Profile_Frame;
import patient.Patient_Operation_Frame;
import patient.Patient_Registration_Frame;
...
public class Login_Frame extends javax.swing.JFrame {
     ...
     */
    public Login_Frame() {
        super("Patient Data Access System");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Patient Data Access System");
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/signup.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/patient_data_access_system/1.jpg"))); // NOI18N
        ...
        jPanel1.setBounds(530, 190, 1008, 670);
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, 0, 1920, 0);

        jButton5.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jButton5.setText("Access Emerency  Patient Data");
        ...
        jButton5.setBounds(1410, 40, 460, 70);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/patient_data_access_system/2.jpg"))); // NOI18N
        getContentPane().add(jLabel8);
        jLabel8.setBounds(0, 0, 1920, 1230);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       if(you.equals("Doctor"))
       {
           this.dispose();
            Doctor_Registration_Frame drf=new Doctor_Registration_Frame();
            Dimension d=Toolkit.getDefaultToolkit().getScreenSize();
            drf.setVisible(true);
            drf.setSize(d);
       }
        if(you.equals("Patient"))
       {
           this.dispose();
            Patient_Registration_Frame prf=new Patient_Registration_Frame();
            Dimension d=Toolkit.getDefaultToolkit().getScreenSize();
            prf.setVisible(true);
            prf.setSize(d);
       }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            if(you.equals("Doctor"))
            {
                ...
                if(dl.isDoctorLogin(st, username, password))
                {
                    Doctor_Edit_Profile_Frame.username=username;
                    this.dispose();
                    Doctor_Operation_Frame dof=new Doctor_Operation_Frame();
                    Dimension d=Toolkit.getDefaultToolkit().getScreenSize();
                    dof.setVisible(true);
                    dof.setSize(d);
                }
               ...
               if(you.equals("Patient"))
            {
                ...
                if(dl.isPatientLogin(st, username, password))
                {
                    Patient_Edit_Profile_Frame.username=username;
                    this.dispose();
                    Patient_Operation_Frame pof=new Patient_Operation_Frame();
                    Dimension d=Toolkit.getDefaultToolkit().getScreenSize();
                    pof.setVisible(true);
                    pof.setSize(d);
                }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        Emergency_Access_Frame eaf=new Emergency_Access_Frame();
       // Dimension d=Toolkit.getDefaultToolkit().getScreenSize();
        eaf.setVisible(true);
        eaf.setLocation(600,200);
        eaf.setSize(1000,700);
